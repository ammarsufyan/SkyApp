...
public class STEAM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_gambarSTEAM = new javax.swing.JPanel();
        ...
        lbl_STEAM.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_STEAM.setForeground(new java.awt.Color(0, 167, 255));
        lbl_STEAM.setText("STEAM");
        getContentPane().add(lbl_STEAM);
        lbl_STEAM.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Voucher-----", "IDR 12.000 Wallet Code", "IDR 45.000 Wallet Code", "IDR 60.000 Wallet Code", "IDR 90.000 Wallet Code", "IDR 120.000 Wallet Code", "IDR 250.000 Wallet Code", "IDR 400.000 Wallet Code", " ", " " }));
        ...
        panel_gambarSTEAM.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarSTEAM.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarSTEAM.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarSTEAMMouseDragged(evt);
            }
        });
        panel_gambarSTEAM.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarSTEAMMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarSTEAMMouseReleased(evt);
            }
        });
        panel_gambarSTEAM.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupSteam.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarSTEAM.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarSTEAM);
        panel_gambarSTEAM.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_STEAM.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("13800");
        } else if (cb == 2) {
            txt_harga.setText("51800");
        } else if (cb == 3) {
            txt_harga.setText("68900");
        } else if (cb == 4) {
            txt_harga.setText("103500");
        } else if (cb == 5) {
            txt_harga.setText("137100");
        } else if (cb == 6) {
            txt_harga.setText("285600");
        } else if (cb == 7) {
            txt_harga.setText("457000");
        }
    ...
    private void panel_gambarSTEAMMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarSTEAMMouseReleased
        panel_gambarSTEAM.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarSTEAMMouseReleased

    private void panel_gambarSTEAMMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarSTEAMMouseDragged
       panel_gambarSTEAM.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarSTEAMMouseDragged

    private void panel_gambarSTEAMMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarSTEAMMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarSTEAMMousePressed
    ...
    private javax.swing.JPanel panel_gambarSTEAM;
