 ...
 */
public class GOP extends javax.swing.JFrame {
    public int saldo;
    public String user;
    ...
    private void initComponents() {
        ...
        panel_gambarGOP = new javax.swing.JPanel();
        ...
        lbl_GP.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_GP.setForeground(new java.awt.Color(0, 167, 255));
        lbl_GP.setText("GOOGLE PLAY");
        getContentPane().add(lbl_GP);
        lbl_GP.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "----Pilih Voucher----", "5000 IDR", "10000 IDR", "20000 IDR", "50000 IDR", "100000 IDR", "200000 IDR", "500000 IDR" }));
        ...
        panel_gambarGOP.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarGOP.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarGOP.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarGOPMouseDragged(evt);
            }
        });
        panel_gambarGOP.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarGOPMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarGOPMouseReleased(evt);
            }
        });
        panel_gambarGOP.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupGooglePlay.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarGOP.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarGOP);
        panel_gambarGOP.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_GP.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("5100");
        } else if (cb == 2) {
            txt_harga.setText("10200");
        } else if (cb == 3) {
            txt_harga.setText("20400");
        } else if (cb == 4) {
            txt_harga.setText("51000");
        } else if (cb == 5) {
            txt_harga.setText("102000");
        } else if (cb == 6) {
            txt_harga.setText("203000");
        } else if (cb == 7) {
            txt_harga.setText("510000");
        }
    ...
    private void panel_gambarGOPMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarGOPMouseReleased
        panel_gambarGOP.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarGOPMouseReleased

    private void panel_gambarGOPMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarGOPMouseDragged
       panel_gambarGOP.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarGOPMouseDragged

    private void panel_gambarGOPMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarGOPMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarGOPMousePressed
    ...
    private javax.swing.JPanel panel_gambarGOP;
