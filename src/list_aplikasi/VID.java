...
public class VID extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_gambarVID = new javax.swing.JPanel();
        ...
        lbl_VID.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_VID.setForeground(new java.awt.Color(0, 167, 255));
        lbl_VID.setText("VIDIO");
        getContentPane().add(lbl_VID);
        lbl_VID.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Paket-----", "7 Hari Platinum", "30 Hari Platinum", "12 Bulan Platinum", " ", " " }));
        ...
        panel_gambarVID.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarVID.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarVID.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarVIDMouseDragged(evt);
            }
        });
        panel_gambarVID.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarVIDMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarVIDMouseReleased(evt);
            }
        });
        panel_gambarVID.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupVidio.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarVID.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarVID);
        panel_gambarVID.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_VID.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("20900");
        } else if (cb == 2) {
            txt_harga.setText("31900");
        } else if (cb == 3) {
            txt_harga.setText("218900");
        } else if (cb == 4) {
        }
    ...
    private void panel_gambarVIDMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarVIDMouseReleased
        panel_gambarVID.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarVIDMouseReleased

    private void panel_gambarVIDMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarVIDMouseDragged
       panel_gambarVID.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarVIDMouseDragged

    private void panel_gambarVIDMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarVIDMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarVIDMousePressed
    ...
    private javax.swing.JPanel panel_gambarVID;
