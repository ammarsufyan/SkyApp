...
public class TEN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_gambarTEN = new javax.swing.JPanel();
        ...
        lbl_NINTENDO.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_NINTENDO.setForeground(new java.awt.Color(0, 167, 255));
        lbl_NINTENDO.setText("NINTENDO eSHOP");
        getContentPane().add(lbl_NINTENDO);
        lbl_NINTENDO.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Voucher-----", "Nintendo eShop Card US$10 ", "Nintendo eShop Card US$20", "Nintendo eShop Card US$50 ", " " }));
        ...
        panel_gambarTEN.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarTEN.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarTEN.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarTENMouseDragged(evt);
            }
        });
        panel_gambarTEN.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarTENMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarTENMouseReleased(evt);
            }
        });
        panel_gambarTEN.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupNintendo.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarTEN.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarTEN);
        panel_gambarTEN.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_NINTENDO.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("294000");
        } else if (cb == 3) {
            txt_harga.setText("735000");
        } else if (cb == 4) {
    ...
    private void panel_gambarTENMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarTENMouseReleased
        panel_gambarTEN.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarTENMouseReleased

    private void panel_gambarTENMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarTENMouseDragged
       panel_gambarTEN.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarTENMouseDragged

    private void panel_gambarTENMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarTENMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarTENMousePressed
    ...
    private javax.swing.JPanel panel_gambarTEN;
