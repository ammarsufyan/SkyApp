...
public class Valorant extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_VALO.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_VALO.setForeground(new java.awt.Color(0, 167, 255));
        lbl_VALO.setText("VALORANT");
        getContentPane().add(lbl_VALO);
        lbl_VALO.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "125 Points", "420 Points", "700 Points", "1375 Points", "2400 Points", "4000 Points", "8150 Points", " ", " " }));
        ...
        panel_gambarValorant.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarValorant.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarValorant.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarValorantMouseDragged(evt);
            }
        });
        panel_gambarValorant.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarValorantMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarValorantMouseReleased(evt);
            }
        });
        panel_gambarValorant.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupValorant.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarValorant.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarValorant);
        panel_gambarValorant.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_VALO.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("80000");
        } else if (cb == 4) {
            txt_harga.setText("150000");
        } else if (cb == 5) {
            txt_harga.setText("250000");
        } else if (cb == 6) {
            txt_harga.setText("400000");
        } else if (cb == 7) {
            txt_harga.setText("800000");
        }
    ...
    private void panel_gambarValorantMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarValorantMouseReleased
        panel_gambarValorant.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarValorantMouseReleased

    private void panel_gambarValorantMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarValorantMouseDragged
       panel_gambarValorant.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarValorantMouseDragged

    private void panel_gambarValorantMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarValorantMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarValorantMousePressed
