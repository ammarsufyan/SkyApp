 ...
 */
public class CODM extends javax.swing.JFrame {
    public int saldo;
    public String user;
    ...
    private void initComponents() {
        ...
        panel_gambarCODM = new javax.swing.JPanel();
        lbl_gambar = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("CALL OF DUTY MOBILE");
        setUndecorated(true);
        ...
        lbl_CODM.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_CODM.setForeground(new java.awt.Color(0, 167, 255));
        lbl_CODM.setText("CALL OF DUTY MOBILE");
        getContentPane().add(lbl_CODM);
        lbl_CODM.setBounds(70, 10, 260, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "317 CP", "634 CP", "1373 CP ", "2059 CP ", "3564 CP", "7656 CP", "15312 CP", " ", " " }));
        ...
        panel_gambarCODM.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarCODM.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarCODM.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarCODMMouseDragged(evt);
            }
        });
        panel_gambarCODM.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarCODMMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarCODMMouseReleased(evt);
            }
        });
        panel_gambarCODM.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupCODM.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarCODM.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarCODM);
        panel_gambarCODM.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_CODM.getText().trim();
...
String cek = EmptyValidation.cekTopupGame(txt_userid, cb_nominal, txt_harga);
    ...
    private void panel_gambarCODMMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarCODMMouseReleased
        panel_gambarCODM.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarCODMMouseReleased

    private void panel_gambarCODMMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarCODMMouseDragged
       panel_gambarCODM.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarCODMMouseDragged

    private void panel_gambarCODMMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarCODMMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarCODMMousePressed
    ...
    private javax.swing.JPanel panel_gambarCODM;
