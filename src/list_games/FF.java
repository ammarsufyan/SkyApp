...
public class FF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_gambarFF = new javax.swing.JPanel();
        ...
        lbl_FF.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_FF.setForeground(new java.awt.Color(0, 167, 255));
        lbl_FF.setText("FREE FIRE");
        getContentPane().add(lbl_FF);
        lbl_FF.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "140 Diamonds", "355 Diamonds", "720 Diamonds ", "1450 Diamonds ", "2180 Diamonds", "3640 Diamonds", "7290 Diamonds", " ", " " }));
        ...
        panel_gambarFF.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarFF.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarFF.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarFFMouseDragged(evt);
            }
        });
        panel_gambarFF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarFFMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarFFMouseReleased(evt);
            }
        });
        panel_gambarFF.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupFF.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarFF.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarFF);
        panel_gambarFF.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_FF.getText().trim();
    ...
    private void panel_gambarFFMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarFFMouseReleased
        panel_gambarFF.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarFFMouseReleased

    private void panel_gambarFFMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarFFMouseDragged
       panel_gambarFF.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarFFMouseDragged

    private void panel_gambarFFMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarFFMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarFFMousePressed
    ...
    private javax.swing.JPanel panel_gambarFF;
