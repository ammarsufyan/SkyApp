 ...
 */
public class AOV extends javax.swing.JFrame {
    public int saldo;
    public String user;
    ...
    private void initComponents() {
        ...
        panel_gambarAOV = new javax.swing.JPanel();
        lbl_gambar = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("ARENA OF VALOR");
        setUndecorated(true);
        ...
        lbl_AOV.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_AOV.setForeground(new java.awt.Color(0, 167, 255));
        lbl_AOV.setText("ARENA OF VALOR");
        getContentPane().add(lbl_AOV);
        lbl_AOV.setBounds(70, 10, 260, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "40 Vouchers", "90 Vouchers", "230 Vouchers", "470 Vouchers", "950 Vouchers", "1430 Vouchers", "2390 Vouchers", " " }));
        ...
        panel_gambarAOV.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarAOV.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarAOV.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarAOVMouseDragged(evt);
            }
        });
        panel_gambarAOV.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarAOVMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarAOVMouseReleased(evt);
            }
        });
        panel_gambarAOV.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupAOV.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarAOV.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarAOV);
        panel_gambarAOV.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_AOV.getText().trim();
    ...
    private void panel_gambarAOVMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarAOVMouseReleased
        panel_gambarAOV.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarAOVMouseReleased

    private void panel_gambarAOVMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarAOVMouseDragged
       panel_gambarAOV.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarAOVMouseDragged

    private void panel_gambarAOVMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarAOVMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarAOVMousePressed
    ...
    private javax.swing.JPanel panel_gambarAOV;
