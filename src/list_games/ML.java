...
public class ML extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_gambarML = new javax.swing.JPanel();
        lbl_gambar = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("MOBILE LEGENDS");
        setUndecorated(true);
        ...
        lbl_ML.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_ML.setForeground(new java.awt.Color(0, 167, 255));
        lbl_ML.setText("MOBILE LEGENDS ");
        getContentPane().add(lbl_ML);
        lbl_ML.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "217 Diamonds + 23 Bonus", "256 Diamonds + 40 Bonus", "367 Diamonds + 41 Bonus", "503 Diamonds + 65 Bonus", "774 Diamonds + 101 Bonus", "1708 Diamonds + 302 Bonus", "4003 Diamonds + 827 Bonus", " ", " " }));
        ...
        panel_gambarML.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarML.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarML.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarMLMouseDragged(evt);
            }
        });
        panel_gambarML.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarMLMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarMLMouseReleased(evt);
            }
        });
        panel_gambarML.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupML.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarML.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarML);
        panel_gambarML.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_ML.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("67925");
        } else if (cb == 2) {
            txt_harga.setText("83600");
        } else if (cb == 3) {
            txt_harga.setText("114950");
        } else if (cb == 4) {
            txt_harga.setText("156750");
        } else if (cb == 5) {
            txt_harga.setText("240350");
        } else if (cb == 6) {
            txt_harga.setText("522500");
        } else if (cb == 7) {
            txt_harga.setText("1254000");
        }
    ...
    private void panel_gambarMLMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarMLMouseReleased
        panel_gambarML.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarMLMouseReleased

    private void panel_gambarMLMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarMLMouseDragged
       panel_gambarML.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarMLMouseDragged

    private void panel_gambarMLMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarMLMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarMLMousePressed
    ...
    private javax.swing.JPanel panel_gambarML;
