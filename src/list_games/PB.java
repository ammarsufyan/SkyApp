...
public class PB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_gambarPB = new javax.swing.JPanel();
        lbl_gambar = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("POINT BLANK");
        setUndecorated(true);
        ...
        lbl_PB.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_PB.setForeground(new java.awt.Color(0, 167, 255));
        lbl_PB.setText("POINT BLANK");
        getContentPane().add(lbl_PB);
        lbl_PB.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "1200 PB CASH", "2400 PB CASH", "6000 PB CASH", "12000 PB CASH", "24000 PB CASH", "36000 PB CASH", "60000 PB CASH", " ", " ", " " }));
        ...
        panel_gambarPB.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarPB.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarPB.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarPBMouseDragged(evt);
            }
        });
        panel_gambarPB.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarPBMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarPBMouseReleased(evt);
            }
        });
        panel_gambarPB.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupPB.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarPB.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarPB);
        panel_gambarPB.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_PB.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("11000");
        } else if (cb == 2) {
            txt_harga.setText("22000");
        } else if (cb == 3) {
            txt_harga.setText("55000");
        } else if (cb == 4) {
            txt_harga.setText("110000");
        } else if (cb == 5) {
            txt_harga.setText("220000");
        } else if (cb == 6) {
            txt_harga.setText("330000");
        } else if (cb == 7) {
            txt_harga.setText("550000");
        }
    ...
    private void panel_gambarPBMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarPBMouseReleased
        panel_gambarPB.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarPBMouseReleased

    private void panel_gambarPBMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarPBMouseDragged
       panel_gambarPB.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarPBMouseDragged

    private void panel_gambarPBMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarPBMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarPBMousePressed
    ...
    private javax.swing.JPanel panel_gambarPB;
