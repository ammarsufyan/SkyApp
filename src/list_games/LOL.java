...
public class LOL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_gambarLOL = new javax.swing.JPanel();
        ...
        lbl_LOL.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_LOL.setForeground(new java.awt.Color(0, 167, 255));
        lbl_LOL.setText("LOL: WILD RIFT");
        getContentPane().add(lbl_LOL);
        lbl_LOL.setBounds(70, 10, 240, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "125 Wild Cores ", "420 Wild Cores ", "700 Wild Cores ", "1375 Wild Cores", "2400 Wild Cores", "4000 Wild Cores", "8150 Wild Cores ", " ", " " }));
        ...
        panel_gambarLOL.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarLOL.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarLOL.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarLOLMouseDragged(evt);
            }
        });
        panel_gambarLOL.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarLOLMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarLOLMouseReleased(evt);
            }
        });
        panel_gambarLOL.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupLolWR.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarLOL.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarLOL);
        panel_gambarLOL.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_LOL.getText().trim();
    ...
    private void panel_gambarLOLMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarLOLMouseReleased
        panel_gambarLOL.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarLOLMouseReleased

    private void panel_gambarLOLMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarLOLMouseDragged
       panel_gambarLOL.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarLOLMouseDragged

    private void panel_gambarLOLMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarLOLMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarLOLMousePressed
    ...
    private javax.swing.JPanel panel_gambarLOL;
