 ...
 */
public class RAGNA extends javax.swing.JFrame {
    public int saldo;
    public String user;
    ...
    private void initComponents() {
        ...
        lbl_ROM.setFont(new java.awt.Font("Poppins SemiBold", 0, 24)); // NOI18N
        lbl_ROM.setForeground(new java.awt.Color(0, 167, 255));
        lbl_ROM.setText("RAGNAROK M");
        getContentPane().add(lbl_ROM);
        lbl_ROM.setBounds(70, 10, 260, 40);

        cb_nominal.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        cb_nominal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-----Pilih Nominal-----", "2450 Diamonds ", "5190 Diamonds ", "10860 Diamonds", "16760 Diamonds", "34810 Diamonds", "55690 Diamonds", "174020 Diamonds", " ", " " }));
        ...
        panel_gambarRAGNAROK.setBackground(new java.awt.Color(204, 204, 204));
        panel_gambarRAGNAROK.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarRAGNAROK.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                panel_gambarRAGNAROKMouseDragged(evt);
            }
        });
        panel_gambarRAGNAROK.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panel_gambarRAGNAROKMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                panel_gambarRAGNAROKMouseReleased(evt);
            }
        });
        panel_gambarRAGNAROK.setLayout(null);

        lbl_gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/frametopup/FrameTopupRagnarokM.png"))); // NOI18N
        lbl_gambar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        panel_gambarRAGNAROK.add(lbl_gambar);
        lbl_gambar.setBounds(0, 0, 600, 600);

        getContentPane().add(panel_gambarRAGNAROK);
        panel_gambarRAGNAROK.setBounds(0, 0, 600, 600);
    ...
    public void set_data() {
        ...
        jenis_topup = lbl_ROM.getText().trim();
    ...
    private void cb_nominalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_nominalActionPerformed
        ...
        if(cb == 0) {
            ...
            txt_harga.setText("160000");
        } else if (cb == 3) {
            txt_harga.setText("330000");
        } else if (cb == 4) {
            txt_harga.setText("500000");
        } else if (cb == 5) {
            txt_harga.setText("1000000");
        } else if (cb == 6) {
            txt_harga.setText("1600000");
        } else if (cb == 7) {
            txt_harga.setText("5000000");
        }
    ...
    private void panel_gambarRAGNAROKMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarRAGNAROKMouseReleased
        panel_gambarRAGNAROK.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_panel_gambarRAGNAROKMouseReleased

    private void panel_gambarRAGNAROKMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarRAGNAROKMouseDragged
       panel_gambarRAGNAROK.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));
    ...
    }//GEN-LAST:event_panel_gambarRAGNAROKMouseDragged

    private void panel_gambarRAGNAROKMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_gambarRAGNAROKMousePressed
        xMouse = evt.getX();
        yMouse = evt.getY();
    }//GEN-LAST:event_panel_gambarRAGNAROKMousePressed
